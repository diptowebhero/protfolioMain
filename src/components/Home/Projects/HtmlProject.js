...
import img4 from "../../../assets/html-project/project4.png";
const HtmlProject = () => {
  return (
          ...
          <Row xs={1} md={2} lg={3} className="g-4 mt-4">
            ...
            <Col>
              <Card className="shadow-lg card-html-project">
                ...
                <Card.Body>
                  <Card.Title as="h2">App Lab Landing Page</Card.Title>
                  <Card.Text as="p">Responsive Landing Page</Card.Text>
                  <Card.Text as="Button" className="btn-tech">
                    HTML5
                  </Card.Text>
                ...
                <Card.Footer>
                  <a
                    href="https://app8lab.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Button className="btn-demo" variant="">
                  ...
                  <a
                    href="https://github.com/diptowebhero/app-lab"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Button className="btn-demo mx-1" variant="">
